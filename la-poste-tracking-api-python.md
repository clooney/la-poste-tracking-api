La Poste Tracking API - Python
================================
Use Python to track La Poste shipments with La Poste Tracking API.
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': 'CB141372389FR,XU007478444TS', 'courier_code': 'laposte'}
