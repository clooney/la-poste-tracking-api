La Poste Tracking API - Java
================================
Use Java to track La Poste shipments with La Poste Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.laposte;
    ...
    public class CreateLaPosteTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("8J01608628504");
                createTrackingParams.setCourierCode("laposte");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateLaPosteTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("CB141372389FR");
                createTrackingParams1.setCourierCode("laposte");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("XU007478444TS");
                createTrackingParams2.setCourierCode("laposte");
...
Get status of the shipment:
    ...
    public class GetLaPosteTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("CB141372389FR,XU007478444TS");
                trackingParams.setCourierCode("laposte");
...
Update a tracking by ID:
    ...
    public class UpdateLaPosteTrackingExample {
