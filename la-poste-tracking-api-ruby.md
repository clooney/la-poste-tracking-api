...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "CB141372389FR","courier_code"=>"laposte"},{"tracking_number" => "XU007478444TS","courier_code"=>"laposte"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"laposte"}
      # params  = {"tracking_numbers" => "XU007478444TS,CB141372389FR","courier_code"=>"laposte"}
...
Update a tracking by ID:
    ...
    begin
      ...
      id_string = '9e72fcfde285536bca6301bc006aa98e'
